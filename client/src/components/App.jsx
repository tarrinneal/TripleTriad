...
class App extends React.Component {
    ...
    this.setState(
      {
        ...
        //   reroll()
        // ],
        player2: [reroll(), reroll(), reroll(), reroll(), reroll()],
  ...
  handleBoardClick(e) {
    ...
    if (
      ...
      !isNaN(+e.target.attributes[0].nodeValue)
    ) {
      ...
      let newPlayer = currPlayer
        .slice(0, selectedCard - 1)
        .concat(currPlayer.slice(selectedCard));
      this.setState(
        {
          newBoardState,
          selectedCard: undefined,
  ...
  checkPlacedCard(loc, user) {
    ...
    locationsToCheck[loc].forEach((check) => {
      if (
        boardState[check.loc] &&
        boardState[check.loc].player !== playerTurn
      ) {
    ...
    this.setState(
      {
        player1Points:
          playerTurn === 1 ? player1Points + changes : player1Points - changes,
        player2Points:
          playerTurn === 2 ? player2Points + changes : player2Points - changes,
